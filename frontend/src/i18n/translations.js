const translations = {
  pt: {
    ...
    proc: {
      filterTitle: 'Tipo de Documento', documentType: 'Tipo de Documento', selectDocType: 'Selecione...',
      newRequest: 'Nova Solicitação de Relatório', reportType: 'Tipo de Relatório', selectReport: 'Selecione o relatório...',
      sendEmail: 'E-mail para envio', emailPlaceholder: 'email@empresa.com (opcional)',
      dynamicFilters: 'Filtros Adicionais (Tags)', addRequest: 'Adicionar Solicitação',
      requests: 'Solicitações', refresh: 'Atualizar', description: 'Descrição', requestedDate: 'Data Solicitação',
      startDate: 'Data Início', endDate: 'Data Fim', download: 'Download', noRequests: 'Nenhuma solicitação encontrada.',
      processing: 'Processando...', requestCreated: 'Solicitação criada com sucesso.',
    },
    util: {
  ...
  en: {
    ...
    proc: {
      filterTitle: 'Document Type', documentType: 'Document Type', selectDocType: 'Select...',
      newRequest: 'New Report Request', reportType: 'Report Type', selectReport: 'Select report...',
      sendEmail: 'Email for delivery', emailPlaceholder: 'email@company.com (optional)',
      dynamicFilters: 'Additional Filters (Tags)', addRequest: 'Add Request',
      requests: 'Requests', refresh: 'Refresh', description: 'Description', requestedDate: 'Requested Date',
      startDate: 'Start Date', endDate: 'End Date', download: 'Download', noRequests: 'No requests found.',
      processing: 'Processing...', requestCreated: 'Request created successfully.',
    },
    util: {
  ...
  es: {
    ...
    proc: {
      filterTitle: 'Tipo de Documento', documentType: 'Tipo de Documento', selectDocType: 'Seleccione...',
      newRequest: 'Nueva Solicitud de Reporte', reportType: 'Tipo de Reporte', selectReport: 'Seleccione el reporte...',
      sendEmail: 'Correo para envío', emailPlaceholder: 'correo@empresa.com (opcional)',
      dynamicFilters: 'Filtros Adicionales (Tags)', addRequest: 'Agregar Solicitud',
      requests: 'Solicitudes', refresh: 'Actualizar', description: 'Descripción', requestedDate: 'Fecha Solicitud',
      startDate: 'Fecha Inicio', endDate: 'Fecha Fin', download: 'Descargar', noRequests: 'No se encontraron solicitudes.',
      processing: 'Procesando...', requestCreated: 'Solicitud creada con éxito.',
    },
    util: {
